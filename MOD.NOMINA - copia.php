...
<form action="rgempl.php" method="POST">
<?php 
				include "consult.php";
...
while($row=mysql_fetch_assoc($result))
			...
			?>
							<CENTER><tr >
					<td>hora:</td>
					<td><input  type= "text" size= 15 require value=" <?php echo $row['he'];?> " name="he"></td></tr>
					<tr >
					<td>nod:</td>
					<td><input type="text" class="table__item" value="<?php echo $row["nod"];?>" name="nod"></td></tr>
					...
					<tr>
					<td>dia feri:</td>
					<td><input type="text" class="table__item" value="<?php echo $row["diaf"];?>" name="diaf"></td></tr>
					<tr>
					<td>be:</td>
					<td><input type="text" class="table__item" value="<?php echo $row["be"];?>"  name="be"></td></tr>
					<tr><td>dad:</td>
					<td><input type="text" class="table__item" value="<?php echo $row["dad"];?>" name="dad"></td></tr>
