...
$sql = "CREATE TABLE `rrh`.`alumnos` (`id_alumno` INT NOT NULL, `nombre` VARCHAR(10) NOT NULL, `carrera` VARCHAR(15) NOT NULL, `grupo` VARCHAR(15) NOT NULL) ENGINE = InnoDB;";
$resAlumnos=$conexion->query($sql);
